public class Program {
    ...
    public static void main(String[] args) {
        String login = "rita_97";
        String password = "qwe123_";
        String confirmPassword = "qwe123_";

        Authorization.verification(login,password,confirmPassword);
...
// выбросить WrongPasswordException. WrongPasswordException и WrongLoginException -
